...
// stored on the lead (and its quiz response) for segmentation. It is never
// shown to the person taking the quiz.
...
// (Dashboard and Team are separate, special tabs handled in the client.)
export const ADMIN_TABS = [
  {
    id: "site",
    label: "Site & Meta",
    note: "Site-wide chrome shown on every page.",
    fields: [
  ...
  },
  {
    id: "landing",
    label: "Landing",
    note: "The waitlist landing page hero.",
    fields: [
  ...
  },
  {
    id: "leadform",
    label: "Lead Form",
    note: "The join-the-waitlist form card.",
    fields: [
  ...
  },
  {
    id: "questions",
    label: "Questions",
    note: "Intro copy, then the questions. Points are an internal lead-qualification weight — summed and stored per lead, never shown to the person taking the quiz.",
    fields: [
  ...
  },
  {
    id: "results",
    label: "Results",
    note: "The after-quiz delivery screen, where the lead magnet is handed over. Use {first_name}.",
    fields: [
